          ...
          -->
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex flex-shrink-0 items-center">
                    <img class="h-8 w-auto rounded-md" src="/vendor/adminlte/dist/img/F.jpg"
                        alt="Your Company">
                </a>
                <!-- Menu lg -->
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center font-bold text-white mt-1">Bienvenido a FARGAblog.com</div>
            </div>
